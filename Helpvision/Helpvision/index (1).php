...
<div class="card text-white bg-primary mb-3" style="width:100%;">
  <div class="card-body">
    <h4 class="card-title text-center">Seja bem vindo(a) a Help Vision!<br><br> 
	Nós chegamos para te ajudar!</h4><br>
...
<a type="button" class="btn btn-success btn-lg btn-block  "  href="cadastro.php" style="align-center"> <h4>CADESTRE-SE <strong>AQUI</strong></h4></a><br>
